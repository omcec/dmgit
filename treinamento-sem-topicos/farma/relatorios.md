...
<mark style="color:red;">\*</mark> RELATÓRIOS DE CLIENTES
...
<mark style="color:red;">\*</mark> **MOVIMENTAÇÃO PERIÓDICA**
...
<mark style="color:red;">**\***</mark>**&#x20;DASHBOARD DE VENDAS**

* Este módulo tem o objetivo de mostrar uma visão geral do negócio em relação às vendas.
* Aqui é possível visualizar as métricas de um determinado período e comparar com período anterior através de gráficos com valores totais.
*

FLUXO DE CAIXA / DRE

* Este módulo serve para visualizar as receitas (vendas) e despesas lançadas no sistema no módulo #contas-a-pagar.
* Então, se você quiser gerenciar toda a movimentação da loja, tudo que entra e sai, desde a venda até a folha de pagamentos e compras de insumos para uso da loja, é aqui que você verá, de forma macro, os valores mensais de tudo que foi realizado e o previsto para o resto do ano.
...
<mark style="color:red;">**\***</mark>**&#x20;VENDAS**
...
<mark style="color:red;">\*</mark> REGISTRO DE EVENTOS

Neste módulo você verifica todas as alterações realizadas no sistema. Como se fosse um diário de bordo de quase tudo que é alterado e registrado.
...
* Este módulo informa todas as Contas a Pagar que deu entrada no sistema.
...
* ​​​​​​​Todas as despesas incluídas em **Operacional > Contas a Pagar** irão aparecer nesse relatório podendo ser filtrado por Período, Fornecedor e Tipo​​​​​​​ de Despesa.\\



<mark style="color:red;">**\***</mark>**&#x20;ESTOQUE**
...
<mark style="color:red;">**\***</mark>**&#x20;HISTÓRICO DE PRODUTOS**
...
<mark style="color:red;">**\***</mark>**&#x20;MANUTENÇÃO DE PEDIDOS**
